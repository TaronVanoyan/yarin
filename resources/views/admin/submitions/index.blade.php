...
<div class="panel panel-default">
    <div class="panel-heading clearfix">
        <h3 class="panel-title">{{ __('app.submitions') }}</h3>
        {{--<div class="buttons pull-right">--}}
            {{--<a class="btn btn-success" href="{{ route('submition.create') }}">--}}
                {{--<i class="icon-plus"></i>--}}
                {{--{{ __('app.create_user') }}--}}
            {{--</a>--}}
        {{--</div>--}}
    ...
    <div class="panel-body">
        <div class="table-responsive">
            <table class="table table-striped table-bordered table-hover data-table"
                   data-url="{{ route('event.submitions',2) }}"
                   data-columns-select='["id","name","lastname","mobile"]'
                ...
                @foreach($submitions as $submition)
                    <tr>
                        ...
                        <td>{{ $submition->lastname }}</td>
                        <td>{{ $submition->mobile }}</td>
