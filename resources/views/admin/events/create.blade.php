        ...
        <div class="col-xs-12 col-md-6 col-md-offset-3">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="{{ route('events.store') }}" method="post" class="form-validate" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-xs-12 col-md-6">

                                <div class="form-group {{ $errors->has('image') ? 'has-error' : '' }}">
                                    <label for="sub_title1" class="">{{ __('event.image') }}</label>

                                    <input id="sub_title1" type="file" class="form-control validate-min-length" data-min-length="6" name="image" value="{{old("image")}}">
                                    @if ($errors->has('image'))
                            ...
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                                    ...
                                    <input id="title" type="text" class="form-control required validate-min-length" data-min-length="2" name="title" value="{{old("title")}}" required autofocus>
                                    @if ($errors->has('title'))
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group {{ $errors->has('sub_title1') ? 'has-error' : '' }}">
                                    ...
                                    <input id="sub_title1" type="text" class="form-control validate-min-length" data-min-length="6" name="sub_title1" value="{{old("sub_title1")}}">
                            ...
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group {{ $errors->has('sub_title2') ? 'has-error' : '' }}">
                                    ...
                                    <input id="sub_title2" type="text" class="form-control required" name="sub_title2" value="{{old("sub_title2")}}">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group {{ $errors->has('syllabus') ? 'has-error' : '' }}">
                                    ...
                                    <input id="syllabus" type="text" class="form-control validate-min-length" data-min-length="6" name="syllabus" value="{{old("syllabus")}}">
                            ...
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group {{ $errors->has('type') ? 'has-error' : '' }}">
                                    <label class="radio-inline"><input type="radio" name="type" value="0" @if(old("type") == 0)checked="checked"@endif>{{ __('event.practical') }}</label>
                                    <label class="radio-inline"><input type="radio" name="type" value="1" @if(old("type") == 1)checked="checked"@endif>{{ __('event.teory') }}</label>
                                    @if ($errors->has('type'))
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                                    ...
                                    <textarea id="description" type="text" class="form-control validate-min-length" data-min-length="6" name="description" >{{ old("description") }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-md-6">
                                ...
                                <div class="form-group {{ $errors->has('start_date') ? 'has-error' : '' }}">
                                    ...
                                    <input id="start_date" type="text" class="form-control validate-min-length" data-min-length="6" name="start_date" value="{{ old("start_date") }}">
                            ...
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group {{ $errors->has('end_date') ? 'has-error' : '' }}">
                                    ...
                                    <input id="end_date" type="text" class="form-control validate-min-length" data-min-length="6" name="end_date" value="{{ old("end_date") }}">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group {{ $errors->has('cost') ? 'has-error' : '' }}">
                                    ...
                                    <input id="cost" type="text" class="form-control validate-min-length" data-min-length="6" name="cost" value="{{ old("cost") }}">
                                    @if ($errors->has('cost'))
                            ...
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group {{ $errors->has('audience') ? 'has-error' : '' }}">
                                    ...
                                    <input id="audience" type="text" class="form-control validate-min-length" data-min-length="6" name="audience" value="{{ old("audience") }}">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group {{ $errors->has('duration') ? 'has-error' : '' }}">
                                    ...
                                    <input id="duration" type="number" class="form-control validate-min-length" data-min-length="6" name="duration" value="{{ old("duration") }}">
                            ...
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group {{ $errors->has('comment') ? 'has-error' : '' }}">
                                    ...
                                    <textarea id="comment" type="text" class="form-control validate-min-length" data-min-length="6" name="comment" >{{ old("comment") }}</textarea>
                            ...
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group {{ $errors->has('teacher') ? 'has-error' : '' }}">
                                    ...
                                    <select id="teacher"  class="form-control validate-min-length" data-min-length="6" name="teacher_id">
                                        <option value="0" @if(old("teacher_id") == 0)selected="selected"@endif>{{__(__("app.select_option"))}}</option>
                            ...
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group {{ $errors->has('event_type') ? 'has-error' : '' }}">
                                    ...
                                    <select id="event_type" type="text" class="form-control validate-min-length" data-min-length="6" name="event_type" >
                                        <option value="0" @if(old("event_type") == 0)selected="selected"@endif>{{__(__("app.select_option"))}}</option>
                                        @foreach($event_types as $type)
                                            <option value="{{$type->id}}" @if(old("event_type") == $type->id)selected="selected"@endif>{{$type->name}}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group {{ $errors->has('feauture_event') ? 'has-error' : '' }}">
                                    ...
                                    <input id="feauture_event" type="checkbox" class="form-control validate-min-length" name="feauture_event" @if(old("feauture_event") ==1)checked="checked"@endif >
